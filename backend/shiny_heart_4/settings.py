"""
Django settings for shiny_heart_4 project.
...
ROOT_URLCONF = 'shiny_heart_4.urls'
...
WSGI_APPLICATION = 'shiny_heart_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shiny_heart_4 API",
    "DESCRIPTION": "API documentation for shiny_heart_4 App",
    "VERSION": "v1",
}
